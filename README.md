...
Always run the linter with auto-fix before committing your changes:

```bash
npm run lint -- --fix
```

This will automatically fix any linting errors and ensure code quality before you push to the repository.
